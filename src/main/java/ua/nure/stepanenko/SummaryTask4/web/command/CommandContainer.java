...
import ua.nure.stepanenko.SummaryTask4.web.command.admin.*;
import ua.nure.stepanenko.SummaryTask4.web.command.common.*;
import ua.nure.stepanenko.SummaryTask4.web.command.manager.*;
import ua.nure.stepanenko.SummaryTask4.web.command.user.*;
